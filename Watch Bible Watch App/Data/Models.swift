...
/// Datenmodelle. Spiegeln exakt das Schema von bible.sqlite (user_version 4).
...
struct Translation: Identifiable, Hashable, Sendable {
    ...
    /// Wie `Localization.supportedLanguages` geschrieben — "de", "en", "es",
    /// "fr", "it", "pt", "zh-Hant", "zh-Hans". Ein Unit-Test haelt beide
    /// Mengen deckungsgleich; die Liste hier nur als Lesehilfe.
    let language: String
