...
- 51 unit tests (Swift Testing) cover the data layer, versification, verse gaps, languages, topics and chapter paging against `test_fixtures.json`, plus the widget's deep link.
